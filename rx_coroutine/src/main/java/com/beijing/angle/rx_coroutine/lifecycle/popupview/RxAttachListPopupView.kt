...
/**
 * @author 刘红鹏
 * @description: Attach类型的列表弹窗   Rxjava生命周期管理
 * @date: 2025/12/26 17:17
 * @Link: https://github.com/AngleCoding
 */

abstract class RxAttachListPopupView(context: Context, bindLayoutId: Int, bindItemLayoutId: Int) :
    AttachListPopupView(context, bindLayoutId, bindItemLayoutId), LifecycleProvider<ActivityEvent> {
